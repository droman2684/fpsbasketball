        ...
        (() => {
          ...
          const availableProspects = (draftProspects ?? [])
            ...
            .map((p) => ({
              ...
              potColorVal: potColor(p.scoutedPotentialRange[1])
            }))
              ...
              <div>
                ...
                >
                  ...
                  <div
                    style={{
                      display: 'grid',
                      gridTemplateColumns: '36px 1fr 44px 40px 78px 92px 80px',
                      padding: '6px 14px',
                      background: COLORS.bg,
                      borderBottom: `1px solid ${COLORS.border}`,
                      fontFamily: FONTS.mono,
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div style={{ fontFamily: FONTS.mono, fontSize: 9, color: COLORS.textFaint }}>
                            {p.origin} · {p.pts} PPG · Scouted {Math.round(p.scoutingProgress)}%
                          </div>
                        </div>
                        ...
                        <span style={{ fontFamily: FONTS.display, fontWeight: 900, fontSize: 14, color: p.ovrColorVal, textAlign: 'center' }}>
                          {p.scoutedOvrRange.lo}-{p.scoutedOvrRange.hi}
                        </span>
                        <span style={{ fontFamily: FONTS.mono, fontSize: 10, fontWeight: 600, color: p.potColorVal, textAlign: 'center' }}>
                ...
                {myPicks.map((pick) => (
                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      {pick.prospect.varianceType !== 'normal' && (
                        <div style={{ fontFamily: FONTS.mono, fontSize: 9, color: COLORS.accent, marginTop: 4, letterSpacing: 0.5 }}>
                          {pick.prospect.varianceType === 'sleeper' ? '📈 SLEEPER' : '📉 BUST'} — scouted{' '}
                          {pick.prospect.scoutedOvrRange.lo}-{pick.prospect.scoutedOvrRange.hi}, actual {pick.prospect.ovr}
                        </div>
                      )}
                    </div>
